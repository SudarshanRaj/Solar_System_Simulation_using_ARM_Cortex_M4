...
long double M[Bodies] = {1.98855e30, 328.5e21, 4.867e24, 5.97219e24, 639e21, 1.898e27};
long double Px[Bodies] = {0, 5.791e10, 1.082e11, 1.47098161e11, 2.279e11, 4.785e11};
long double Py[Bodies] = {0, 0, 0, 0, 0, 0};
long double Vx[Bodies] = {0, 0, 0, 0, 0, 0};
long double Vy[Bodies] = {0, 41000, 33000, 30300, 24300, 12300};
#endif


#if 1
 double G = 6.67384e-11;
 double M[Bodies] = {1.98855e30, 5.97219e24, 7.3476e22};
 double Px[Bodies] = {0, 1.47098161e11, 1.480085454e11};
 double Py[Bodies] = {0, 0, 10000};
 double Vx[Bodies] = {0, 0, 0};
 double Vy[Bodies] = {0, 30300, 30800};
...
{
	 double dVx[Bodies],dVy[Bodies];
	 double Rx[Bodies][Bodies], Ry[Bodies][Bodies];
	 double Dsq[Bodies][Bodies];
	 double D[Bodies][Bodies];
	 double F[Bodies][Bodies];
	 double Fx[Bodies][Bodies];
	 double Fy[Bodies][Bodies];
	 double FxNet[Bodies] = {0,0,0};
	 double FyNet[Bodies] = {0,0,0};
