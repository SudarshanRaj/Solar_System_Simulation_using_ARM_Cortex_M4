...
#if 1
float G = 6.67384e-11;
float M[Bodies] = {1.98855e30, 328.5e21, 4.867e24, 5.97219e24, 639e21, 1.898e27, 568.3e24, 86.81e24, 102.4e24, 102.4e24,102.4e24,328.5e21, 4.867e24, 5.97219e24, 639e21, 1.898e27, 568.3e24, 86.81e24, 102.4e24, 102.4e24,102.4e24,328.5e21, 4.867e24, 5.97219e24, 639e21, 1.898e27, 568.3e24, 86.81e24, 102.4e24, 102.4e24,102.4e24,328.5e21, 4.867e24, 5.97219e24, 639e21, 1.898e27, 568.3e24, 86.81e24, 102.4e24, 102.4e24};
float Px[Bodies] = {0, 5.791e10, 1.082e11, 1.47098161e11, 2.279e11, 3.085e11, 3.73e11, 4.57e11, 5.03e11, 5.03e11,0, 5.791e10, 1.082e11, 1.47098161e11, 2.279e11, 3.085e11, 3.73e11, 4.57e11, 5.03e11, 5.03e11,0, 5.791e10, 1.082e11, 1.47098161e11, 2.279e11, 3.085e11, 3.73e11, 4.57e11, 5.03e11, 5.03e11,0, 5.791e10, 1.082e11, 1.47098161e11, 2.279e11, 3.085e11, 3.73e11, 4.57e11, 5.03e11, 5.03e11};
float Py[Bodies] = {0, 0, 0, 0, 0, 0, 0, 0, 0};
float Vx[Bodies] = {0, 0, 0, 0, 0, 0, 0, 0, 0};
float Vy[Bodies] = {0, 41000, 33000, 30300, 24300, 12300, 16000, 15000, 12000, 12000,0, 41000, 33000, 30300, 24300, 12300, 16000, 15000, 12000, 120000, 41000, 33000, 30300, 24300, 12300, 16000, 15000, 12000, 120000, 41000, 33000, 30300, 24300, 12300, 16000, 15000, 12000, 12000};
float dVx[Bodies],dVy[Bodies];
float F[Bodies][Bodies];
float Fx[Bodies][Bodies];
float Fy[Bodies][Bodies];
...
int volatile Computation_Visualization=1;
...
void Calc_Force_Update_Pixel()
{
	...
	float Rx[Bodies][Bodies], Ry[Bodies][Bodies];
	float FxNet[Bodies] = {0,0,0};
	float FyNet[Bodies] = {0,0,0};
	float Dsq[Bodies][Bodies];
	float D[Bodies][Bodies];
