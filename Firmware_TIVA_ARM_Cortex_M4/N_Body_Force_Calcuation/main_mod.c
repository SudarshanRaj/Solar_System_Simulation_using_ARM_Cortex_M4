...
volatile int Computation_Visialization=0;
int Iteration=365;
...
int volatile Count=0,EarthOrbitCount=1;
...
int main(void)
{
	...
	if(Computation_Visialization)

	{
		for(Calc_Iteration=0;Calc_Iteration<Iteration;Calc_Iteration++)
		{
#if INSTRUMENTATION
